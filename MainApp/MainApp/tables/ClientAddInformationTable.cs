...
{
    class ClientAddInformationTable : TableBase
    {
        #region コンストラクタ
        public ClientAddInformationTable(string table_name, bool isChecked)
                                    ...
                                    string sex, string birth_day, string course_id)
        {
            ...
            insert_num += db_manager.insertClientAddInformation(date, client_id, division);
        }
        #endregion
                                    ...
                                    string sex, string birth_day, string course_id)
        {
            ...
            insert_num_old += db_manager.insertClientAddInformation(date, client_id, division);
        }
        #endregion
    }
}
